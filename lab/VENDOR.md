...
- Scope `/lab/` on purpose: narrow registration keeps this worker out of
  the tour pages' way (no root-scope worker exists anymore). Verified
  alongside shim-served pages with zero interference.
